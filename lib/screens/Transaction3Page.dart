              ...
              child: PrimaryButton(
                ...
                onTap: () {
                     ...
                     if (cropName.isNotEmpty &&
                         ...
                         if (selectedIndex >= 0 && selectedIndex < transaction3.length) {
    ...
    return Scaffold(
      ...
      ListView.builder(
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: ListTile(
            leading: QrImage(
             data: '${transaction3[index].id},${transaction3[index].crop_name},${transaction3[index].Quantity},${transaction3[index].price},${transaction3[index].Customer},${transaction3[index].timeStamp},',
             version: QrVersions.auto,
              gapless: false,
              size: 200.0,
             ),
